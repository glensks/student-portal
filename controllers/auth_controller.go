...
type StudentRegisterRequest struct {
	// No StudentID — assigned by registrar after approval
	// No Password  — system generates temp password upon registrar approval
...
func RegisterStudent(c *gin.Context) {
	...
	// student_id = NULL — assigned by registrar upon approval
	// password   = NULL — generated by system upon registrar approval
	res, err := tx.Exec(`
